...
export default function Footer() {
  return (
    ...
    <div className='lg:max-w-full max-w-[1440px]  bg-blue-900' >
        <div className='max-w-[1440px] mx-auto py-4 mt-24 px-4 grid lg:grid-cols-3 gap-8 bg-blue-900  text-white'>
            <div>
